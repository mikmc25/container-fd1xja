...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fd1xja.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fd1xja.containers.anotherwebservice.com/
...
```
git clone git@github.com:mikmc25/container-fd1xja.git
cd container-fd1xja
```
...
```
docker attach container-fd1xja
```
